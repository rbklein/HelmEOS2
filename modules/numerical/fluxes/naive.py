...
def div_naive_3d(u):
    return div_x_naive_3d(u) + div_y_naive_3d(u) + div_z_naive_3d(u)


''' 2D versions of the naive fluxes for testing purposes '''

def div_x_naive_2d(u):
    """
...
def div_naive_2d(u):
    return div_x_naive_2d(u) + div_y_naive_2d(u)
